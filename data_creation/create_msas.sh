...
mmseqs search query_full uniref50 target_full tmp/ --num-iterations 3 -a -s 8 -e 0.1 --max-seqs 10000
#mmseqs align query_full uniref50 target_full align_full -a
